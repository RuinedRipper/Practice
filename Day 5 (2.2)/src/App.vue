<template>
  <div class="center" id="app">
    ...
    <h3 style="font-family: 'Lucida Sans Unicode', 'Lucida Grande', Sans-Serif">
      Конвертор
    </h3>
    ...
    async convert({ amount, fromCurrency, toCurrency }) {
      if (amount !== "" && fromCurrency !== "" && toCurrency !== "") {
        if (fromCurrency === toCurrency) {
          this.converterCurrency = Number(amount).toFixed(2);
        } else {
          ...
          if (data) {
            ...
            if (Number(toCurrencyCode.number) === 980) {
              ...
              this.converterCurrency = (amount * CurrencyRate.rateBuy).toFixed(
                2
              );
              ...
              this.converterCurrency = (amount / CurrencyRate.rateSell).toFixed(
                2
              );
            } else {
